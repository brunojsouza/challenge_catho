...
class NetworkingImpl(private val webService: WebService) : Networking, BaseNetworking() {
    ...
    override suspend fun doLogin(apiKey: String, userId: String): LoginResponse = /*doLoginFromMock()*/
        doRequest { webService.doLogin(apiKey, userId) }

    override suspend fun getPositions(apiKey: String): List<PositionResponse> =  /*getPositionsFromMock()*/
